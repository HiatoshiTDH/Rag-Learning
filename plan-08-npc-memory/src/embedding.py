...
the backend changes the vector dimension -> delete data/qdrant and let the
service re-index.
"""
...
class VoyageEmbedder:
    """voyage-3: multilingual (matters if memories are written in any language), 1024 dims."""
